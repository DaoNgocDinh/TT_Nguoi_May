...
@section('title', 'Xác thực - Nạp tiền & Data')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600">Bước 6: Nhập mã PIN để xác thực giao dịch nạp tiền hoặc mua Data</p>
    </div>

    <!-- Progress Bar -->
    <div class="mb-8 bg-white rounded-xl p-6 shadow-lg">
        <div class="flex items-center justify-between mb-4">
            <div class="text-sm font-semibold"><span class="text-[#A0185F]">Bước 6</span> / 6</div>
        </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gradient-to-br from-[#A0185F] to-[#8B1550] text-white rounded-[32px] shadow-2xl p-10">
                    <div class="text-center">
                        <div class="text-5xl mb-6"><i class="fas fa-lock"></i></div>
                        <h2 class="text-3xl font-bold mb-3">Xác thực giao dịch</h2>
                        <p class="opacity-90 text-base leading-7">Nhập mã PIN 6 chữ số của bạn để hoàn tất giao dịch an toàn.</p>
                    </div>
                </div>

                <!-- Form nhập PIN -->
                <div class="bg-white rounded-[32px] shadow-2xl p-8 border border-gray-100">
                    <form action="/nap-tien-dien-thoai/thanh-cong" method="get" class="space-y-6">
                    <label class="block text-sm font-semibold text-[#121212] mb-4">Mã PIN (6 chữ số)</label>
                    <input type="password" name="pin" placeholder="● ● ● ● ● ●" maxlength="6" inputmode="numeric" pattern="\d{6}" required
                    ...
                    <div class="mt-8 grid gap-4 sm:grid-cols-2">
                        <a href="/nap-tien-dien-thoai/xac-nhan" class="inline-flex items-center justify-center px-6 py-4 bg-gray-200 text-gray-800 rounded-[24px] font-semibold hover:bg-gray-300 transition">
                            Quay lại
                        </a>
                        <button type="submit" class="inline-flex items-center justify-center px-6 py-4 bg-[#A0185F] text-white rounded-[24px] font-semibold hover:bg-[#8B1550] transition">
                            Xác thực
                        </button>
                    </div>
                </form>
